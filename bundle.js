...
/***/ function(module, exports, __webpack_require__) {
	...
	var Router = __webpack_require__(157);var Route = Router.Route;
	...
	var routes = React.createElement(Route, { path: '/', handler: routing, location: 'history' }, React.createElement(DefaultRoute, { handler: Welcome }), React.createElement(Route, { name: 'signup', path: '/signup', handler: SignUp }), React.createElement(Route, { name: 'login', path: '/login', handler: Login }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = React.createClass({ displayName: "Home",
	    render: function render() {
	        return React.createElement("div", null, React.createElement("h1", null, "Welcom to mini twitter"), React.createElement("a", { href: "/#/signup" }, "SignUp"), React.createElement("br", null), React.createElement("a", { href: "/#/login" }, "Login"));
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = React.createClass({ displayName: 'Login',
	    ...
	    render: function render() {
	        return React.createElement('div', null, React.createElement('h1', null, 'Login Page'), React.createElement('table', null, React.createElement('tr', null, React.createElement('td', null, 'Username'), React.createElement('td', null, React.createElement('input', { type: 'text', label: 'username', ref: 'username' }))), React.createElement('tr', null, React.createElement('td', null, 'Pass'), React.createElement('td', null, React.createElement('input', { type: 'text', label: 'pass', ref: 'pass' }))), React.createElement('tr', null, React.createElement('td', null), React.createElement('td', null, React.createElement('input', { type: 'submit', onClick: this.login })))));
	    }
	});
